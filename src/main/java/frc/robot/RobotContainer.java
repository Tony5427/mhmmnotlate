...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    lSpeed1 = new SteelTalonsController(Constants.LEFT_TOP_MOTOR, false, 1);
    lSpeed2 = new SteelTalonsController(Constants.LEFT_BOTTOM_MOTOR, false, 1);
    rSpeed1 = new SteelTalonsController(Constants.RIGHT_TOP_MOTOR, false, 1);
    rSpeed2 = new SteelTalonsController(Constants.RIGHT_BOTTOM_MOTOR, false, 1);
    ...
    intakeSpeed = new SteelTalonsController(Constants.INTAKE_MOTOR, false, 1);
    intake = new Intake(intakeSpeed);

    transportSpeed = new SteelTalonsController(Constants.TRANSPORT_MOTOR,false,1);
    transport = new Transport(transportSpeed);

    pulleySpeed = new SteelTalonsController(Constants.PULLEY_MOTOR,false,1);
    pulley = new Pulley(pulleySpeed);

    shootLeft = new SteelTalonsController(Constants.SHOOTER_MOTOR_TOP, false, 1);
    shootRight = new SteelTalonsController(Constants.SHOOTER_MOTOR_BOTTOM, false, 1);
    shooter = new Shooter(shootLeft, shootRight);

    eLeft = new SteelTalonsController(Constants.ELEVATOR_LEFT_PORT_1, false, 1);
    eRight = new SteelTalonsController(Constants.ELEVATOR_RIGHT_MOTOR, false, 1);
    rLimitSwitch = new DigitalInput(Constants.ELEVATOR_LIMIT_RIGHT);
    lLimitSwitch = new DigitalInput(Constants.ELEVATOR_LIMIT_LEFT);
    lEncoder = new Encoder(Constants.ELEVATOR_LEFT_PORT_1,Constants.ELEVATOR_LEFT_PORT_2);
    rEncoder = new Encoder(Constants.ELEVATOR_RIGHT_PORT_1,Constants.ELEVATOR_RIGHT_PORT_2);
  ...
  private void configureButtonBindings() {
    ...
    intakeIn = new JoystickButton(joystick, Constants.INTAKE_BUTTON);

    intakeIn.whileHeld(new MoveIntake(Constants.INTAKE_TELEOP_SPEED));
    ...
    shoot.whileHeld(new MoveShooter(Constants.SHOOTER_TELEOP_SPEED, Constants.SHOOTER_TELEOP_SPEED));

    eUP = new JoystickButton(joystick, Constants.ELEVATOR_UP_BUTTON);
    eUP.whileHeld(new MoveElevator(Constants.ELEVATOR_SPEED, Constants.ELEVATOR_SPEED));
    eDOWN = new JoystickButton(joystick, Constants.ELEVATOR_DOWN_BUTTON);
